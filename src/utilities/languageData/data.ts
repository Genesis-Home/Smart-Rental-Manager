...
export const languageData: LanguageData[] = [
  ...
  },
  {
    ...
    translation: {
      ...
      propertyToVisitors: "Ακίνητο προς Επισκέπτες",
      ...
      visitData: "Ημερομηνία & Ώρα Επίσκεψης",
      ...
      advanceAmount: "Ποσό Προκαταβολής",
      ...
      notes: "Σημειώσεις",
      noNotesAdded: "Δεν έχουν προστεθεί ακόμη σημειώσεις",
      editNotes: "Επεξεργασία Σημειώσεων",
      generatedOn: "Δημιουργήθηκε στις",
      thankYouMessage: "Ευχαριστούμε που επιλέξατε τις υπηρεσίες μας!",
      notesSavedSuccessfully: "Οι σημειώσεις αποθηκεύτηκαν επιτυχώς",
      failedToSaveNotes: "Απέτυχε η αποθήκευση των σημειώσεων",
      contactType: "Contact Type",
      newContact: "New Contact",
      existingContact: "Existing Contact",
      selectContact: "Select Contact",
