...
export const languageData: LanguageData[] = [
  ...
  },
  {
    ...
    translation: {
      ...
      accountUseDetails1:
        "Διατηρήστε ασφαλή τα στοιχεία σύνδεσής σας. Είστε υπεύθυνοι για τη δραστηριότητα του λογαριασμού σας.",
      appPurpose: "2. Σκοπός Εφαρμογής",
      appPurposeDetails:
        "Η εφαρμογή βοηθά τα πρακτορεία στη διαχείριση καταχωρήσεων ακινήτων και προγραμματισμό επισκέψεων πελατών.",
      appPurposeDetails1:
        "Οι πελάτες δεν χρησιμοποιούν την εφαρμογή — τα δεδομένα τους προστίθενται χειροκίνητα από τα πρακτορεία.",
      dataPrivacy: "3. Απόρρητο Δεδομένων",
      dataPrivacyDetails:
        "Τα δεδομένα κάθε πρακτορείου είναι ιδιωτικά και δεν κοινοποιούνται με άλλους.",
      dataPrivacyDetails1:
        "Είστε ιδιοκτήτης των δεδομένων σας και είστε υπεύθυνοι για την ακρίβειά τους.",
      communication: "4. Επικοινωνία",
      communicationDetails:
        "Δεν επιτρέπεται η επικοινωνία ή η κοινοποίηση δεδομένων μεταξύ διαφορετικών πρακτορείων.",
      emailsAndSharing: "5. Email & Κοινοποίηση",
      emailsAndSharingDetails:
        "Η εφαρμογή στέλνει αυτοματοποιημένα email για επιβεβαιώσεις επίσκεψης.",
      emailsAndSharingDetails1:
        "Οι επιλογές κοινοποίησης (WhatsApp, αντιγραφή, κλπ.) παρέχονται για ευκολία.",
      DataExport: "6. Εξαγωγή Δεδομένων",
      dataExportDetails:
        "Τα πρακτορεία μπορούν να εξάγουν αρχεία επισκέψεων σε Excel για δική τους χρήση.",
      security: "7. Ασφάλεια",
      securityDetails:
        "Λαμβάνουμε τυπικά μέτρα για την προστασία των δεδομένων, αλλά δεν είμαστε υπεύθυνοι για κατάχρηση ή τεχνικά προβλήματα.",
      termination: "8. Τερματισμός",
      terminationDetails:
        "Οι λογαριασμοί μπορεί να ανασταλούν εάν παραβιαστούν οι όροι.",
      terminationDetails1:
        "Μπορείτε να ζητήσετε τη διαγραφή του λογαριασμού σας οποιαδήποτε στιγμή.",
      Contact: "Επικοινωνία",
      Eemail: "Email: [Εισαγωγή Email]",
      Address: "Διεύθυνση: [Εισαγωγή Διεύθυνσης]",
      termsAndConditionsTitle:
        "Χρησιμοποιώντας αυτή την εφαρμογή, συμφωνείτε με τους ακόλουθους όρους:",
      ...
      clientVisitDetails:
        "Λεπτομέρειες επίσκεψης πελάτη (όνομα, email, τηλέφωνο, αριθμός επισκεπτών, ώρα επίσκεψης, ακίνητο, τοποθεσία)",
      ...
      shareVisitInfo:
        "Κοινοποίηση πληροφοριών επίσκεψης μέσω WhatsApp ή άλλων εφαρμογών",
      privacySecurity: "Απόρρητο & Ασφάλεια",
      dataIsolation:
        "Τα δεδομένα κάθε πρακτορείου είναι απομονωμένα — χωρίς κοινοποίηση μεταξύ πρακτορείων",
      passwordEncryption: "Οι κωδικοί είναι κρυπτογραφημένοι",
      secureDataStorage:
        "Τα δεδομένα αποθηκεύονται με ασφάλεια και έχουν πρόσβαση μόνο εξουσιοδοτημένοι χρήστες",
      yourControl: "Ο Έλεγχός Σας",
      accountControl:
        "Οι χρήστες πρακτορείων μπορούν να ενημερώσουν ή να διαγράψουν τα δεδομένα τους οποιαδήποτε στιγμή. Για διαγραφή λογαριασμού, επικοινωνήστε μαζί μας στο [Εισαγωγή Email].",
      search: "Αναζήτηση",
      ...
      adults: "Ενήλικες",
      noSchedulesInRange:
        "Δεν βρέθηκαν προγραμματισμοί στο επιλεγμένο εύρος ημερομηνιών.",
      ...
      Revenue: "Έσοδα",
      confirmDelete:
        "Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτό το διαμέρισμα;",
