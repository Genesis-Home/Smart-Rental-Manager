...
export const languageData: LanguageData[] = [
  {
    ...
    translation: {
      ...
      notes: "After booking",
      noNotesAdded: "No after booking added yet",
      editNotes: "Edit After booking",
      generatedOn: "Generated on",
      thankYouMessage: "Thank you for choosing our services!",
      notesSavedSuccessfully: "After booking saved successfully",
      failedToSaveNotes: "Failed to save after booking",
  ...
  },
  {
    ...
    translation: {
      ...
      notes: "Μετά την κράτηση",
      noNotesAdded: "Δεν έχουν προστεθεί ακόμη μετά την κράτηση",
      editNotes: "Επεξεργασία Μετά την κράτηση",
      generatedOn: "Δημιουργήθηκε στις",
      thankYouMessage: "Ευχαριστούμε που επιλέξατε τις υπηρεσίες μας!",
      notesSavedSuccessfully: "Οι μετά την κράτηση αποθηκεύτηκαν επιτυχώς",
      failedToSaveNotes: "Απέτυχε η αποθήκευση των μετά την κράτηση",
      contactType: "Contact Type",
      newContact: "New Contact",
      existingContact: "Existing Contact",
      selectContact: "Select Contact",
